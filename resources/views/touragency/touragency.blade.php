			...
			<div class="card-header bg-secondary">
				<div class="d-flex">
					<div class="align-self-center">
						<h3 class="m-b-0 text-white">Show All Tour Agency List</h3>
					</div>
					<div class="ml-auto">
	...
	<div class="modal-dialog modal-dialog-centered">
		<div class="modal-content">
			<div class="modal-header">
				<h4 class="modal-title" >Are you sure to delete this Agency?</h4>
								...
								<div class="row p-t-20">
									<div class="col-md-12">
										<div class="form-group row">
											<label  class="col-sm-4 control-label">Agency Name:<span
												class="text-danger">*</span></label>
												<div class="col-sm-8">
													<div class="controls">
														<input 
														type="text" maxlength="60" name="agency_name" class="form-control" id="agency_name"
										...
										<div class="col-md-12">
											<div class="form-group row">
												<label  class="col-sm-4 control-label">Agency Email:<span
													class="text-danger">*</span></label>
													<div class="col-sm-8">
														<div class="controls">
															<input type="text" maxlength="60" name="user_email" class="form-control" id="user_email"
															placeholder=" Agency Email Address" required>
														</div>
													</div>
												</div>
											</div>
											...
											<div class="col-md-12">
												<div class="form-group row">
													<label for="name" class="col-sm-4 control-label"> Agency Phone:<span class="text-danger">*</span></label>
													<div class="col-sm-8">
														<div class="controls">
															<input type="number" min="0" maxlength="15" name="phone_num" class="form-control" id="phone_num" placeholder="Agency Phone Number" required>
														</div>
													</div>
												</div>
											</div>
											...
											<div class="col-md-12">
												<div class="form-group row">
													<label for="name" class="col-sm-4 control-label">Agency Address:</label>
													<div class="col-sm-8">
														<div class="controls">
															<textarea type="text" name="user_address" class="form-control" id="user_address"
															placeholder="Agency Address"row="3" ></textarea>
														</div>
													</div>
												</div>
											</div>
				...
				<script type="text/javascript">
					$(document).ready(function() {
        						...
        						$('#addBtn').click(function(event) {
        							...
        							$('#modalHeader').html('New Agency Information');
