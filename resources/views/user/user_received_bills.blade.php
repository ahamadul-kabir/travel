...
@section('pageTitle', 'Received bills')
@push('styles')
    ...
    <div class="col-12">
        <div class="card">
            <div class="card-header bg-info">
                <div class="d-flex">
                    <div>
                        <h4 class="card-title m-b-0 text-white">Received bills of {{session('name')}}</h4>
                    </div>
                </div>
            </div>
            <div class="card-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <div class="input-group">
                                        <select readonly name="blood_group" id="blood_group" class="form-control custom-select">
...
return $('#ipdHistoryList').DataTable({
    ...
    serverSide: true,
    ajax: {
        url: "{{ url('userReceivedBillsData') }}/" + startDateParam + '/' + endDateParam,
        type: 'GET',
    },
    "order": [
        [1, 'desc']
